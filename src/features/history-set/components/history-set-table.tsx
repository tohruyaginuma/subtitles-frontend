...
export const HistorySetTable = forwardRef<HTMLTableRowElement, Props>(
  ({ historySetList, isLoading }, ref) => {
    return (
      <>
        <Table>
          <TableHeader>
          ...
          <TableBody>
            {isLoading && historySetList.length === 0 ? (
...
HistorySetTable.displayName = "HistorySetTable";
